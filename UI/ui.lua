...
-- TEMA AZUL NEON - FACILMENTE MODIFICÁVEL
local ThemeColors = {
    -- Cores principais - modifique aqui para alterar todo o tema
    Primary = Color3.fromRGB(0, 150, 255),        -- Azul principal
    PrimaryDark = Color3.fromRGB(0, 80, 180),     -- Azul escuro
    PrimaryLight = Color3.fromRGB(100, 200, 255), -- Azul claro
    Accent = Color3.fromRGB(0, 200, 255),         -- Azul neon/accent
    
    -- Cores de fundo
    Background = Color3.fromRGB(10, 10, 15),      -- Fundo principal
    SecondaryBg = Color3.fromRGB(15, 20, 30),     -- Fundo secundário
    TertiaryBg = Color3.fromRGB(25, 30, 40),      -- Fundo terciário
    Border = Color3.fromRGB(40, 50, 70),          -- Bordas
    
    -- Cores de texto
    TextPrimary = Color3.fromRGB(240, 245, 255),  -- Texto primário
    TextSecondary = Color3.fromRGB(180, 200, 230),-- Texto secundário
    TextDisabled = Color3.fromRGB(100, 120, 150), -- Texto desabilitado
    
    -- Cores de status
    Success = Color3.fromRGB(0, 200, 100),        -- Sucesso (verde azulado)
    Error = Color3.fromRGB(255, 80, 80),          -- Erro (vermelho)
    Warning = Color3.fromRGB(255, 200, 0)         -- Aviso (amarelo)
}

-- Sistema de notificações fixado
    ...
    function self:create_tab(title, icon)
        ...
        function TabManager:create_module(settings)
            ...
            if not settings.rich then
                ...
                ModuleName.Text = settings.richtext or "<font color='rgb(0,150,255)'>River</font> Module"
            end
